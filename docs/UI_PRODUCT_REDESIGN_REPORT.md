...
- `src/photovault/ui/pages/activity_page.py`, `collections_page.py`,
  ...
  `duplicates_page.py`, `backup_profiles_page.py`, and
  `backup_health_page.py`: dedicated page
...
1. Replace the remaining flat page construction branches with page and
   ...
   Duplicates, Backup Profiles, and Backup Health builders plus shared tile
