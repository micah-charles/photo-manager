...
- `src/photovault/ui/pages/activity_page.py`, `collections_page.py`,
  ...
  `people_page.py`, `places_page.py`, `categories_page.py`, and
  `duplicates_page.py`: dedicated page builders for Activity, Collections,
  Library, Photo Viewer/Inspector, Android Backup, People, Places, Categories,
  and Visual Duplicates
...
1. Replace the remaining flat page construction branches with page and
   ...
   Photo Viewer, Android Backup, People, Places, Categories, and Visual
   Duplicates builders plus shared tile components are now in place.
