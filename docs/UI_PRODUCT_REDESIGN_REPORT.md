...
- `src/photovault/ui/pages/activity_page.py`, `collections_page.py`,
  ...
  `duplicates_page.py`, and `backup_profiles_page.py`: dedicated page
  builders for Activity, Collections, Library, Photo Viewer/Inspector,
  Android Backup, People, Places, Categories, Visual Duplicates, and Backup
  Profiles
...
1. Replace the remaining flat page construction branches with page and
   ...
   Duplicates, and Backup Profiles builders plus shared tile components are
   now in place.
