...
def build_timeline_page(owner: object, layout: object, tables: dict[str, QTableWidget]) -> None:
    ...
    create_event = QPushButton("Create event from dates")
    create_event.setToolTip("Open the Event form with this timeline date range pre-filled")
    create_event.clicked.connect(owner._create_event_from_timeline_dates)
    controls.addWidget(create_event)
