...
def stylesheet() -> str:
    ...
    QListWidget#CollectionGrid, QListWidget#AlbumGrid, QListWidget#PeopleGrid, QListWidget#PlacesGrid {{ background: {t['surface']}; border: 1px solid {t['border']}; border-radius: 8px; padding: 10px; min-height: 120px; }}
    QListWidget#CollectionGrid::item, QListWidget#AlbumGrid::item, QListWidget#PeopleGrid::item, QListWidget#PlacesGrid::item {{ border: 1px solid transparent; border-radius: 8px; padding: 6px; margin: 4px; }}
    QListWidget#CollectionGrid::item:hover, QListWidget#AlbumGrid::item:hover, QListWidget#PeopleGrid::item:hover, QListWidget#PlacesGrid::item:hover {{ background: {t['selection']}; border-color: #c9dbff; }}
    QListWidget#CollectionGrid::item:selected, QListWidget#AlbumGrid::item:selected, QListWidget#PeopleGrid::item:selected, QListWidget#PlacesGrid::item:selected {{ background: {t['selection']}; border-color: {t['primary']}; }}
